...
def adicionar_contato():
    ...
    verificar_nome = conexaoDB.cursor.execute('SELECT * FROM Contatos WHERE nome = ?', (nome,))
...
def procurarNome():
    ...
    if procurar is None:
        ...
        listar = conexaoDB.cursor.execute('SELECT * FROM Contatos WHERE nome = ?', (nome,)).fetchall()
